# Low-Cost RAG Chatbot Solution (Python 3.13)

A serverless, cost-effective generative AI chatbot solution with Retrieval-Augmented Generation (RAG) capabilities for small to medium businesses. **Starting at just $29.76/month** with Graviton3 ARM64 architecture. Built with Python 3.13 for improved performance and modern language features.
